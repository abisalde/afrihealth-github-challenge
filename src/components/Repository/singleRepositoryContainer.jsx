        ...
        <div className="repo-contents-desc">
          ...
          <div className="codelang-fork-date">
            <span className="codelang">
              ...
              ></span>{" "}
              <span className="programming-language">{codeLangName}</span>
            </span>
            <span
              className={
                starCount === 0 ? "starred-count-display" : "starred-count"
              }
            >
              <BiStar /> <span className="star-count">{starCount}</span>{" "}
            </span>
            ...
            <span className="date-update">
              Updated on{" "}
              <time dateTime={updatedAt}>{readableDate(updatedAt)}</time>
            </span>
          </div>
        </div>
