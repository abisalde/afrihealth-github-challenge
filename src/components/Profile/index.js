    ...
    <div className="profile-card-content">
      <div className="profile-avatar-username">
        <div className="avatar-status">
          <img
            className="avatar"
            src={profile.avatarUrl ? profile.avatarUrl : ImagePlaceHolder}
            alt={profile?.name}
          />
        </div>
          ...
          <div className="followers-following">
            ...
            >
              ...
              <span className="followers">
                {profile.followers.totalCount && profile.followers.totalCount}
              </span>
              followers ·{" "}
            </a>
            <a
            ...
            >
              <span className="following">
                {profile.following.totalCount && profile.following.totalCount}
              </span>
              following ·{" "}
            </a>
            <a
