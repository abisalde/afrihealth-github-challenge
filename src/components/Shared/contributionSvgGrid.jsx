    ...
    <>
      <svg height="112" className="js-calendar-graph-svg">
        <g transform="translate(10, 20)">
          ...
          <text x="105" y="-7" className="contribution-calendar-label">
            Dec
          </text>
          <text x="157" y="-7" className="contribution-calendar-label">
            Jan
          </text>
          ...
          <text x="612" y="-7" className="contribution-calendar-label">
            Sep
          </text>
          <text x="664" y="-7" className="contribution-calendar-label">
            Oct
          </text>
          <text
            textAnchor="start"
