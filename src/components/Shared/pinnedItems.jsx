      ...
      <div className="pinned-item-list-content">
        ...
        <div className="codelang-fork-date">
          <span className="codelang">
            ...
            ></span>{" "}
            <span className="programming-language">{languageName}</span>
          </span>
          <span
            className={
              stargazerCount === 0 ? "starred-count-display" : "starred-count"
            }
          >
            <BiStar /> <span className="star-count">{stargazerCount}</span>{" "}
          </span>
          <span
            className={forkCount === 0 ? "fork-repo-display" : "fork-repo"}
            value={forkCount}
          >
            <svg
              aria-label="fork"
