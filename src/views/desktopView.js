                        ...
                        <div className='follow-aboutme-location'>
                            ...
                            <div className='aboutme-location'>
                                <div className='aboutme-desc'>
                                    <p>
                                        JavaScript Developer | IT Support
                                        Engineer
                                    </p>
                                </div>
                                <div className='followers-following'>
                                    <a className='link-follows' href='#'>
                                        ...
                                        <span className='followers'>43</span>
                                        followers ·{' '}
                                    </a>
                                    <a className='link-follows' href='#'>
                                        <span className='following'>35</span>
                                        following ·{' '}
                                    </a>
                                    <a className='link-follows' href='#'>
                                        <i
                                    ...
                                    <div className='repo-contents-desc'>
                                        <div className='repo-details'>
                                            ...
                                            <p className='repo-desc'>
                                                This is mini project start-up
                                                for webpack and babel starter
                                            </p>
                                        </div>
